...
CREATE TABLE projects (
  ...
  start_date DATE,
  end_date DATE,
  zone VARCHAR(50) DEFAULT 'R1',
  plot_area NUMERIC DEFAULT 10000,
  created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP
);
...
-- Seed Mock Projects
INSERT INTO projects (id, name, description, status, created_by, start_date, end_date, zone, plot_area) VALUES
('11111111-1111-1111-1111-111111111111', 'The Helix Cultural Center', 'A 50,000 sq ft performing arts center featuring a parametric spiral facade, an 800-seat main auditorium, and sustainable rooftop gardens. Targeting LEED Gold certification.', 'ongoing', '00000000-0000-0000-0000-000000000001', '2026-02-10', '2027-12-31', 'R1', 30000),
('22222222-2222-2222-2222-222222222222', 'Zenith Mixed-Use Towers', 'Twin 30-story residential and commercial towers featuring sky-bridges, passive cooling architectural louvers, and integrated transit connection.', 'ongoing', '00000000-0000-0000-0000-000000000001', '2026-03-01', '2028-06-30', 'TOZ', 20000),
('33333333-3333-3333-3333-333333333333', 'Apex Waterfront Villa', 'Luxury net-zero residential project built over a cliff edge. Features cantilevered concrete slabs, smart home energy grids, and custom water harvesting.', 'upcoming', '00000000-0000-0000-0000-000000000001', '2026-05-15', '2027-08-30', 'R2', 10000);
...
INSERT INTO doc_versions (id, document_id, revision_number, file_url, file_size, change_summary, created_by, built_up_area) VALUES
('vvvvvvvv-vvvv-vvvv-vvvv-vvvvvvvvvv01', 'dddddddd-dddd-dddd-dddd-dddddddddd01', 1, '/drawings/helix_auditorium_v1.jpg', 14205800, 'Initial upload of structural layout and seating lines.', '00000000-0000-0000-0000-000000000004', 50000),
('vvvvvvvv-vvvv-vvvv-vvvv-vvvvvvvvvv02', 'dddddddd-dddd-dddd-dddd-dddddddddd02', 1, '/drawings/helix_facade_v1.jpg', 8900400, 'Initial design facade framing details approved by client.', '00000000-0000-0000-0000-000000000002', 8000);
