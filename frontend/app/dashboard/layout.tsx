...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground transition-colors duration-200 relative overflow-x-hidden">
      ...
      <div className="absolute top-[80px] left-0 w-[300px] h-[600px] pointer-events-none select-none z-0 hidden xl:block opacity-40">
        <svg width="100%" height="100%" viewBox="0 0 300 600" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="rgba(29, 78, 216, 0.08)" strokeWidth="1">
          {/* Isometric Structure */}
          ...
          <line x1="30" y1="150" x2="30" y2="300" stroke="rgba(29, 78, 216, 0.15)" />
          <line x1="25" y1="150" x2="35" y2="150" stroke="rgba(29, 78, 216, 0.15)" />
          <line x1="25" y1="300" x2="35" y2="300" stroke="rgba(29, 78, 216, 0.15)" />
          <text x="18" y="230" fill="rgba(29, 78, 216, 0.25)" fontSize="8" fontFamily="monospace" transform="rotate(-90 18 230)">H: 15.00m</text>

          <line x1="50" y1="320" x2="150" y2="370" stroke="rgba(29, 78, 216, 0.15)" />
          <text x="90" y="350" fill="rgba(29, 78, 216, 0.25)" fontSize="8" fontFamily="monospace" transform="rotate(26 90 350)">W: 10.00m</text>
          ...
          <text x="190" y="440" fill="rgba(29, 78, 216, 0.25)" fontSize="8" fontFamily="monospace">45° N</text>

          {/* Project Data Stamp */}
          <rect x="30" y="550" width="160" height="35" stroke="rgba(29, 78, 216, 0.1)" />
          <text x="35" y="561" fill="rgba(29, 78, 216, 0.25)" fontSize="7" fontFamily="monospace">DWG NO: SEC-A-09</text>
          <text x="35" y="571" fill="rgba(29, 78, 216, 0.25)" fontSize="7" fontFamily="monospace">SCALE: 1:100</text>
          <text x="35" y="581" fill="rgba(29, 78, 216, 0.25)" fontSize="7" fontFamily="monospace">SaaS ERP REDESIGN</text>
        </svg>
      </div>

      {/* Blueprint SVG Vector Backdrop - Right Side */}
      <div className="absolute top-[120px] right-0 w-[300px] h-[600px] pointer-events-none select-none z-0 hidden xl:block opacity-40">
        <svg width="100%" height="100%" viewBox="0 0 300 600" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="rgba(29, 78, 216, 0.08)" strokeWidth="1">
          ...
          <circle cx="75" cy="430" r="4" stroke="rgba(29, 78, 216, 0.2)" />
          <circle cx="125" cy="390" r="4" stroke="rgba(29, 78, 216, 0.2)" />
          <circle cx="175" cy="350" r="4" stroke="rgba(29, 78, 216, 0.2)" />
          
          {/* Coordinate lines */}
          <line x1="10" y1="520" x2="290" y2="520" strokeDasharray="4,4" />
          <text x="220" y="512" fill="rgba(29, 78, 216, 0.25)" fontSize="8" fontFamily="monospace">GRID LINE A-12</text>
        </svg>
      </div>
